#define FFI_SCOPE "libexpat"
#define FFI_LIB "libexpat.so"
...
typedef void( *XML_CharacterDataHandler)(void *userData, const void *s, int len);
...
//void XML_SetCharacterDataHandler(XML_Parser parser, void (*handler)(void *userData, const XML_Char *s, int len ));
...
// XML_Parser XML_ExternalEntityParserCreate(XML_Parser parser, const XML_Char *context,
//                               const XML_Char *encoding);
